...
enum pf1550_buck_current_limits {
    CURRENT_LIMIT_1_0A,
    CURRENT_LIMIT_1_2A,
    CURRENT_LIMIT_1_5A,
    CURRENT_LIMIT_2_0A,
...
static int regulator_pf1550_set_dvs_state(const struct device *dev, regulator_dvs_state_t state) {
    return 0;
}

static const regulator_parent_driver_api parent_api = {
    .dvs_state_set = regulator_pf1550_set_dvs_state,
...
static int regulator_pf1550_count_voltages(const struct device *dev) {
    return 0;
}

static int regulator_pf1550_list_voltages(const struct device *dev, unsigned int idx, int32_t * volt_uv) {
    return 0;
}

static int regulator_pf1550_set_voltage(const struct device *dev, int32_t min_uv, int32_t max_ux) {
    return 0;
}
...
static int regulator_pf1550_list_current_limits(const struct device *dev, unsigned int idx, int32_t *current_ua) {
    return 0;
}

static int regulator_pf1550_set_current_limit(const struct device *dev, int32_t min_ua, int32_t max_ua) {
    return 0;
}
